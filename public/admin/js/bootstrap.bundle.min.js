...
!function(t, e) {
    ...
    N.on(window, Ds, ( () => {
        for (const t of z.find(qs))
            Vs.getOrCreateInstance(t)
    }
    )),
    m(Vs);
    const Ks = ".bs.toast"
    ...
    class ro extends W {
        ...
        show() {
            N.trigger(this._element, Zs).defaultPrevented || (this._clearTimeout(),
        ...
        hide() {
            this.isShown() && (N.trigger(this._element, Gs).defaultPrevented || (this._element.classList.add(no),
            this._queueCallback(( () => {
