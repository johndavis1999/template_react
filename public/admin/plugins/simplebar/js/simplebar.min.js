...
!function(t, e) {
    ...
    var Qt = Object.keys || function(t) {
      ...
      , re = Object.create || function(t, e) {
        var r;
        return null !== t ? (te.prototype = T(t),
        r = new te,
        te.prototype = null,
        r[Zt] = t) : r = ee(),
        void 0 === e ? r : Kt(r, e)
    ...
    var oe, se, ae, ce = function(t) {
        ...
        return t = Mt(t),
        O(t, fe) ? t[fe] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? he : null
    }
    , pe = zt("iterator"), ve = !1;
    [].keys && ("next"in (ae = [].keys()) ? (se = de(de(ae))) !== Object.prototype && (oe = se) : ve = !0),
    null == oe && (oe = {}),
    O(oe, pe) || W(oe, pe, (function() {
        return this
    }
    ));
    var ge = {
      ...
      , ke = function(t, e, r, n, i, o, s) {
        ...
        if (y && (a = de(y.call(new t)),
        Oe !== Object.prototype && a.next && (de(a) !== Oe && (we ? we(a, Oe) : "function" != typeof a[Se] && W(a, Se, Ae)),
        me(a, f, !0))),
        "values" == i && v && "values" !== v.name && (h = !0,
        g = function() {
            return v.call(this)
        }
        ),
      ...
      , er = e((function(t) {
        var e = R.f
          ...
          , s = t.exports = {
            ...
            onFreeze: function(t) {
                return tr && s.REQUIRED && i(t) && !O(t, r) && o(t),
                t
            }
        };
        q[r] = !0
    ...
    zt("iterator"))
      ...
      , sr = e((function(t) {
        ...
        (t.exports = function(t, r, n, i, o) {
            ...
            for (; !(f = s.next()).done; )
                if ((u = or(s, d, f.value, i)) && u instanceof e)
                    return u;
            return new e(!1)
        }
        ).stop = function(t) {
        ...
        getConstructor: function(t, e, r, n) {
            var i = t((function(t, o) {
              ...
              , s = function(t, e, r) {
                var n = o(t)
                  , i = dr(T(e), !0);
                return !0 === i ? mr(n).set(e, r) : i[n.id] = r,
                t
            };
    ...
    var Gr = function(t, e, r) {
        ...
        if ("function" != typeof t)
            throw new TypeError(Tr);
        return Xr(r) && (n = "leading"in r ? !!r.leading : n,
    ...
    function Fn(t, e) {
        ...
        return r.cache = new (Fn.Cache || Nn),
        r
    }
    function Bn(t) {
        var e = typeof t;
    ...
    zn.prototype.set = function(t, e) {
        return this.__data__[t] = Wn && void 0 === e ? vn : e,
        this
    }
    ,
    ...
    Cn.prototype.delete = function(t) {
        var e = this.__data__
          , r = In(e, t);
        return !(r < 0) && (r == e.length - 1 ? e.pop() : jn.call(e, r, 1),
        !0)
    }
    ,
    ...
    var Un = 20
      ...
      , Jn = function() {
        ...
        t.prototype.connect_ = function() {
            ...
            Kn ? (this.mutationsObserver_ = new MutationObserver(this.refresh),
    ...
    Yt && window.addEventListener("resize", (function() {
        vi !== window.devicePixelRatio && (vi = window.devicePixelRatio,
        pi = null)
    }
    ));
    var yi = function(t) {
    ...
    Ai.call(Oi, "a"),
    Ai.call(_i, "a"),
    0 !== Oi.lastIndex || 0 !== _i.lastIndex), Ti = void 0 !== /()??/.exec("")[1];
    (Mi || Ti) && (Li = function(t) {
        var e, r, n, i, o = this;
        return Ti && (r = new RegExp("^" + o.source + "$(?!\\s)",Si.call(o))),
        Mi && (e = o.lastIndex),
        n = Ai.call(o, t),
    ...
    var Ri = zt("species")
      ...
      , Ci = function(t, e, r, n) {
        ...
        if (!o || !s || "replace" === t && !Wi || "split" === t && !zi) {
            ...
            J(RegExp.prototype, i, 2 == e ? function(t, e) {
        ...
        e.onTrackClick = function(t, e) {
            ...
            this.options.clickOnTrack) {
                ...
                !function t() {
                    ...
                    i)),
                    n.requestAnimationFrame(t)) : s < c && (s += 40,
    ...
    Yi.initHtmlApi = function() {
        ...
        "undefined" != typeof MutationObserver && (this.globalObserver = new MutationObserver(Yi.handleMutations),
